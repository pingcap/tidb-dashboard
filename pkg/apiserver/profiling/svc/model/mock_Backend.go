...
func (_m *MockBackend) AuthFn(_a0 ...Operation) []gin.HandlerFunc {
...
func (_m *MockBackend) GetBundleData(_a0 GetBundleDataReq) (GetBundleDataResp, error) {
	ret := _m.Called(_a0)
...
func (_m *MockBackend) GetProfileData(_a0 GetProfileDataReq) (GetProfileDataResp, error) {
	ret := _m.Called(_a0)
...
func (_m *MockBackend) ListBundles() (ListBundlesResp, error) {
	ret := _m.Called()
...
func (_m *MockBackend) ListTargets() (ListTargetsResp, error) {
	ret := _m.Called()
...
func (_m *MockBackend) StartBundle(_a0 StartBundleReq) (StartBundleResp, error) {
	ret := _m.Called(_a0)
