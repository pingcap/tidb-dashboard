...
const zh: I18nLocale = {
  ...
  "Next": "未来",
  "Past": "过去",
  "Please select a start time after {{time}}.": "请选择 {{time}} 之后的开始时间。",
  "Please select an end time after the start time.": "请确保结束时间在开始时间之后。",
  "Please select an end time before {{time}}.": "请选择 {{time}} 之前的结束时间。",
  "Start": "开始",
  "The selection exceeds the {{duration}} limit, please select a shorter time range.": "选择超出了 {{duration}} 的限制，请选择更短的时间范围。"
}
