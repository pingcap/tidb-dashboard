...
function getData(data: StatementModel): InfoModel[] {
  return [
    {
      name: "Query Time",
      value: formatValue(data.avg_latency ?? 0, "ns"),
      level: 0,
    ...
    {
      name: "Parse Time",
      value: formatValue(data.avg_parse_latency ?? 0, "ns"),
      level: 1,
      desc: "Time consumed when parsing the query",
    },
    {
      name: "Compile",
      value: formatValue(data.avg_compile_latency ?? 0, "ns"),
      level: 1,
      desc: "Time consumed when optimizing the query",
    },
    {
      name: "Coprocessor Wait Time",
      value: formatValue(data.avg_wait_time ?? 0, "ns"),
      level: 1,
    },
    {
      name: "Coprocessor Execution Time",
      value: formatValue(data.avg_process_time ?? 0, "ns"),
      level: 1,
    },
    {
      name: "Backoff Retry Time",
      value: formatValue(data.avg_backoff_time ?? 0, "ns"),
      level: 1,
      desc: "The waiting time before retry when a query encounters errors that require a retry",
    },
    {
      name: "Get Commit Ts Time",
      value: formatValue(data.avg_get_commit_ts_time ?? 0, "ns"),
      level: 1,
    },
    {
      name: "Local Latch Wait Time",
      value: formatValue(data.avg_local_latch_wait_time ?? 0, "ns"),
      level: 1,
    },
    {
      name: "Resolve Lock Time",
      value: formatValue(data.avg_resolve_lock_time ?? 0, "ns"),
      level: 1,
    },
    {
      name: "Prewrite Time",
      value: formatValue(data.avg_prewrite_time ?? 0, "ns"),
      level: 1,
    },
    {
      name: "Commit Time",
      value: formatValue(data.avg_commit_time ?? 0, "ns"),
      level: 1,
    },
    {
      name: "Commit Backoff Retry Time",
      value: formatValue(data.avg_commit_backoff_time ?? 0, "ns"),
      level: 1,
    },
  ]
}
