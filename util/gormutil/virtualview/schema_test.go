...
func TestDecodeField(t *testing.T) {
	...
	require.Equal(t, "MyDigest", f.columnName)
	...
	require.Equal(t, "", f.viewExpr)
	require.Equal(t, "query_value", f.columnName)
	...
	require.Equal(t, "timestamp", f.columnName)
	...
	require.Equal(t, "", f.viewExpr)
	require.Equal(t, "json_unexported", f.columnName)
	...
	require.Equal(t, "", f.viewExpr)
	require.Equal(t, "json_skip", f.columnName)
	...
	require.Equal(t, "", f.viewExpr)
	require.Equal(t, "invalid_tag", f.columnName)
	...
	require.Equal(t, "", f.viewExpr)
	require.Equal(t, "gorm_invalid", f.columnName)
	...
	require.Equal(t, "json_alias", f.columnName)
	...
	require.Equal(t, "full_col", f.columnName)
