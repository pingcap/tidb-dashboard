...
// NewMockTopologyProvider creates a new instance of MockTopologyProvider. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockTopologyProvider(t testing.TB) *MockTopologyProvider {
